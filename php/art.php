        ...
        <div class="container-fluid">
          ...
          <div class="navbar-collapse d-xl-flex collapse" id="navbarsExample11">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <div class="align-items-lg-center pt-3">
                  <a href="../php/art.php" class="btn gradient-bg-1 text-white rounded-pill px-5 mx-2 py-2 ">Art</a>
                </div>
              </li>
              <li class="nav-item">
                <div class="align-items-lg-center pt-3">
                ...
                <div class="w-100 shadow border border-1 border-secondary-subtle rounded-5 px-4 py-4 my-2">
                  ...
                  <div id="artname" class="d-flex flex-nowrap justify-content-between">
                      ...
                      <div class="h-100 d-flex justify-content-center align-items-center">
                        <a href="art-overview.php?id=<?php echo $data['id']; ?>"  id="art-btn" class=" d-flex justify-content-center align-items-center color11 rounded-circle">
                  ...
                  <div id="artthumbnail" class="d-flex justify-content-center mb-lg-3 mb-0 pb-lg-0">
                    <a href="art-overview.php?id=<?php echo $data['id']; ?>" class="w-100">
                      <img src="<?php echo $data['artlink'] ?>" alt="<?php echo $data['name'] ?>" width="100%" height="100%" class="object-fit-cover rounded-4">
                    </a>
                  </div>
                </div>
                </td>
